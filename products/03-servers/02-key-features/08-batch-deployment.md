...
We actually created batch deployments while developing our [Spot Market](/products/getting-started/deployment-options/spot-market.md) feature, as we need to validate the prices / availability in batches before each spot instance is deployed.
